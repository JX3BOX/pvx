<template>
    <el-dialog :title="plan.title" v-model="show" custom-class="m-plan-dialog" @close="close">
...
<script>
import { getItemPlanID, delItemPlan, searchItemsID } from "@/service/manufacture/plan.js";

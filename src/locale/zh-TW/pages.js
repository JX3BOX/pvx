    ...
    wiki: {
        ...
        overview: {
            ...
            ui: {
                ...
                workbench: {
                    ...
                    hiddenTier: "隱藏成就",
                    categoryProgressHint: "全部分類進度（實際完成）",
        ...
        leap: {
            ...
            ui: {
                ...
                workbench: {
                    baseSettings: "方案基礎",
                    baseSettingsDescription: "系統推薦與自選方案共用",
                    plannerKicker: "自選方案",
                    ...
                    costLedger: "難度維度",
                    routeList: "成就難度維度與衝刺路線",
                    costLedgerDescription: "維度名稱、順序與顯示項由公共難度介面提供；已配置項按 0–5 級星級顯示並參與排序。",

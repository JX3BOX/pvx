        ...
        overview: {
            ...
            ui: {
                ...
                workbench: {
                    ...
                    sortDifficultyAsc: "難度從低到高（待資料）",
                    sortTimeAsc: "預計耗時從低到高（待資料）",
        ...
        leap: {
            ...
            ui: {
                ...
                workbench: {
                    ...
                    futureDataNote: "成本與耗時欄位將隨介面補齊；缺失資料不會參與排序或估算。",
                    ...
                    costLedger: "五維算帳",
                    routeList: "成就成本帳本與衝刺路線",
                    costLedgerDescription: "金錢、時間、運氣、難度與性價比僅在介面提供真實值時顯示並參與排序。",
                    ...
                    difficultyAscending: "難度由低至高",
                    timeAscendingPending: "耗時由低至高（需資料）",
                    costAscendingPending: "成本由低至高（需資料）",
                    noRouteResults: "調整關鍵字或篩選條件後再試。",
                    costFormulaHint: "綜合成本需要金錢、時間、運氣和難度四項都有值；任一欄位缺失時顯示「—」，不會產生虛構評分。",
                    costLevels: {
                        money: { 1: "免費", 2: "少量", 3: "中等", 4: "很貴", 5: "天價" },
                        time: { 1: "幾分鐘", 2: "幾小時", 3: "數天", 4: "數週", 5: "數月" },
                        luck: { 1: "必出", 2: "高機率", 3: "看情況", 4: "低機率", 5: "純看臉" },
                    },
                    costTiers: { free: "白給", good: "划算", grind: "硬肝", trap: "深坑" },

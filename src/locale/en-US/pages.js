export default {
    ...
    wiki: {
        sidebar: {
            ...
            recordedSeniorityPoints: "Recorded",
        ...
        difficultyDimensions: {
            ...
            sortAscending: "{label}: low to high",
            sortDescending: "{label}: high to low",
            loadFailed: "Difficulty dimensions could not be loaded. Default dimensions are in use.",
            sortLoadFailed: "Difficulty data for sorting could not be loaded. Your current sort has been kept.",
        },
        overview: {
            ...
            ui: {
                ...
                statistics: {
                    regular: "Standard Achievements",
                    regularHidden: "Standard Achievements (Hidden)",
                    wujia: "Five-Armor Achievements",
                    wujiaHidden: "Five-Armor Achievements (Hidden)",
                    fireworks: "99 Fireworks Achievements",
                    retired: "Retired Achievements",
                    seniorityUnit: "seniority",
                    achievementUnit: "achievements",
                    collectedAchievements: "Recorded achievements",
                    collectedSeniority: "Recorded seniority",
                    statisticsScope: "Statistics scope",
                    includesHidden: "Includes hidden",
                    visibleOnly: "Visible only",
                    remainingSeniority: "Still obtainable",
                    completedResultCount: "{count} completed",
                ...
                workbench: {
                    ...
                    tierTitle: "Category Overview",
                    filterNormalAchievements: "Filter standard achievements",
                    filterWujiaAchievements: "Filter Five-Armor achievements",
                    viewHiddenAchievements: "View hidden achievements",
                    hiddenTier: "Hidden Achievements",
                    categoryProgressHint: "Categories adjust for school restrictions; subcategories show actual completion",
                    secondaryCategories: "{count} subcategories",
                    categorySort: "Category Sort",
                    sortProgressAsc: "Completion low to high (gaps first)",
                    sortProgressDesc: "Completion high to low",
                    sortRemainingDesc: "Obtainable seniority high to low",
                    ...
                    sortPriority: "Incomplete First",
                    sortPointsDesc: "Points high to low",
                    sortPointsAsc: "Points low to high",
                    sortDifficultyAsc: "Difficulty low to high",
                    sortTimeAsc: "Time cost low to high",
                    searchPlaceholder: "Search achievement name / description",
                    search: "Search",
                    reset: "Reset",
                    ...
                    completionRate: "Synced completion rate",
                    levelValue: "{value}/5",
                    emptyTitle: "No matching achievements",
                    emptyDescription: "Try changing the category, status, or search filters.",
                    allCategories: "All",
                    loadingTitle: "Building your seniority compendium",
                    loadingDescription: "Loading character and achievement progress.",
                },
            },
        },
        compare: {
            ...
            ui: {
                ...
                workbench: {
                    comparisonRoles: "Compared Characters",
                    selfBadge: "Me",
                    roleLimit: "Up to {count} characters",
                    remainingRoleSlots: "You can add {count} more characters",
                    summaryExpand: "Expand character overview",
                    summaryCollapse: "Collapse character overview",
                    currentScope: "Current scope",
                    availablePoints: "{points} seniority available to work on",
                    difficulty: "Difficulty",
                    estimatedTime: "Estimated time",
                    minutes: "{count} min",
                    timeCost: "Time cost",
                    levelValue: "{value}/5",
                    analysisSeal: "A",
                    analysisTitle: "Show detailed analysis",
                    analysisHint: "Cross stats · Structure · Weak categories",
                    totalComparison: "Total Seniority Comparison",
                    totalComparisonHint: "Earned seniority / recorded seniority",
                    crossTitle: "Cross Analysis",
                    crossHint: "Uses the first two characters",
                    commonCompleted: "Completed by both",
                    crossPrimaryOnly: "Only {role} completed",
                    crossSecondaryOnly: "Only {role} completed",
                    commonIncomplete: "Incomplete for both",
                    structureTitle: "Seniority Structure Overlay",
                    weakTitle: "Shared Weak Categories",
                    weakHint: "Good group targets",
                    needTwoRoles: "Add at least two characters to generate cross analysis and shared weak categories.",
                },
            },
        },
        leap: {
            ...
            ui: {
                ...
                workbench: {
                    ...
                    futureDataNote: "Estimated minutes and recommendation cost tiers still need future data or rules; missing values are excluded from estimates.",
                    systemRecommendation: "SYSTEM RECOMMENDATION",
                    recommendationTitle: "{stage} strategy",
                    refreshRecommendation: "Analyze again",
                    recommendedCategories: "Categories",
                    recommendationCandidateCount: "Candidates",
                    recommendationAvailablePoints: "Available points",
                    recommendedCategoryHeading: "Priority categories for this stage",
                    recommendedCategoryMeta: "{count} incomplete · {points} points",
                    recommendationScore: "Score {score}",
                    recommendationCoverage: "{available}/{total} recommendation dimensions active",
                    viewRecommendationWeights: "View stage weights and data coverage",
                    categoryWeightNote: "Category ranking: candidate quality {quality}% · incomplete pool {count}% · available points {points}%",
                    dimensionCoverage: "{value} coverage",
                    dimensionPending: "Data pending",
                    recommendationEditableNote: "You can still change categories and add or remove achievements before saving.",
                    generateFromRecommendation: "Generate from recommendation",
                    noRecommendation: "No incomplete general achievements are currently available for a recommendation.",
                    recommendationDimensions: {
                        points: "Point gain",
                        efficiency: "Time efficiency",
                        difficulty: "Low difficulty",
                        money: "Low money cost",
                        time: "Low time cost",
                        luck: "Low randomness",
                    },
                    recommendationStages: {
                        newbie: { label: "Starter · under 30k", description: "Prioritize easy, quick, and low-cost achievements to build an early point base." },
                        growth: { label: "Growth · 30k–75k", description: "Favor categories that balance reliable gains with reasonable effort." },
                        sprint: { label: "Sprint · 75k–100k", description: "Increase point-gain and route-density weights to finish high-value groups." },
                        tribulation: { label: "Tribulation · 100k+", description: "With a sparse remaining pool, emphasize feasibility, long-term cost, and actual gain." },
                    },
                    allCategories: "All categories",
                    selectedCategories: "{count} categories selected",
                    planRole: "Character",
                    clients: { std: "Standard", origin: "Legacy" },
                    planClientMismatchTitle: "Plan client mismatch",
                    planClientMismatchDescription: "This plan belongs to {client}. Switch to that client to view or edit it.",
                    planClientMismatchWarning: "This plan belongs to {client}. Switch clients first.",
                    difficultyLimit: "Difficulty limit",
                    noLimit: "No limit",
                    andBelow: "and below",
                    routeStrategy: "Route strategy",
                    strategyEasy: "Easiest first (recommended)",
                    strategyPoints: "Highest points first",
                    strategyEfficiencyPending: "Time efficiency (data pending)",
                    strategyCostPending: "Lowest cost (data pending)",
                    mapScope: "Map scope",
                    allMaps: "All maps",
                    categoryScope: "Included categories",
                    ...
                    projectedSeniority: "Projected seniority",
                    surplusPoints: "Above target",
                    ...
                    overallDifficulty: "Overall difficulty",
                    globalCompletionRate: "Synced completion rate",
                    tags: "Tags",
                    levelValue: "{value}/5",
                    schoolRestriction: "School",
                    routeNote: "Notes / shortcuts",
                    action: "Actions",
                    removeRouteItem: "Delete",
                    removeRouteItemLabel: "Delete {name} from this route",
                    addRouteItems: "Add achievements",
                    addRouteItemsDescription: "Search this character's incomplete general achievements. Route totals update automatically after adding one.",
                    searchRouteItemsToAdd: "Search achievement name or description",
                    searchRouteItems: "Search",
                    searchingRouteItems: "Searching…",
                    addRouteItem: "Add to route",
                    routeItemAdded: "Added",
                    addRouteItemsSearchHint: "Enter a keyword to find achievements that can be added.",
                    noRouteItemsToAdd: "No incomplete general achievements matched your search.",
                    addRouteItemsSearchFailed: "Could not search achievements. Please try again.",
                    finishAdding: "Done",
                    routeOrder: "Route order",
                    pointsDescending: "Points: high to low",
                    noRouteResults: "Adjust the search or filters and try again.",
                    costFormulaHint: "Difficulty dimensions come from the public API and use a 0–5 star scale. Missing values show “—”; tags retain their original admin labels.",
                    costLevels: {
                        money: { 1: "Free", 2: "Low", 3: "Medium", 4: "Expensive", 5: "Extreme" },
                        time: { 1: "Minutes", 2: "Hours", 3: "Days", 4: "Weeks", 5: "Months" },
                        luck: { 1: "Guaranteed", 2: "Likely", 3: "Variable", 4: "Unlikely", 5: "Pure luck" },
                    },
                    savedPlanCount: "{count} plans",
                    viewPlan: "View",
                    editPlan: "Edit",
                    copyAsMine: "Copy to my plans",
                    deletePlanShort: "Delete",
                    requestGuidance: "Achievement coach review",
                    guidanceSubmitting: "Submitting…",
                    guidanceSubmitted: "Review requested",
                    moreActions: "More",
                    guidanceSimulationTitle: "Request achievement coach review",
                    guidanceSimulationDescription: "Simulation only: submit “{title}” for {role}. No request will be sent to the server.",
                    guidanceSimulationConfirm: "Simulate request",
                    guidanceSimulationSuccess: "A simulated review request was created. It will enter coach review after the API is connected.",
                    updatePlan: "Update plan",
                    savePlan: "Save plan",
                    saveDescription: "Save {count} achievements worth an estimated {points} seniority points.",
                    saving: "Saving…",
                    updateSuccess: "Plan updated.",
                    updateFailed: "Could not update the plan. Please try again later.",
                    copyTitle: "{title} · Copy",
                    loading: "Loading breakthrough plans…",
                    roleLoadFailed: "Could not load this character's achievement state.",
                    planListLoadFailed: "Could not load the plan list.",
                    targetMustExceedCurrent: "The target must be higher than current seniority.",
                    noCandidates: "No incomplete achievements match the current conditions.",
                    difficultyFallback: "Difficulty is unavailable, so the difficulty limit was not applied.",
                    planDetailLoadFailed: "Could not load plan details",
                    localGenerationNote: "This route was generated locally. Save it when you are ready.",
                    discardRoute: "Discard route",
                },
                emptyValue: "—",
            },
        },

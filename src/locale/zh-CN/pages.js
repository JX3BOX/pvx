        ...
        overview: {
            ...
            ui: {
                ...
                workbench: {
                    ...
                    sortDifficultyAsc: "难度从低到高（待数据）",
                    sortTimeAsc: "预计耗时从低到高（待数据）",
        ...
        leap: {
            ...
            ui: {
                ...
                workbench: {
                    ...
                    futureDataNote: "成本与耗时字段将随接口补齐；缺失数据不会参与排序或估算。",
                    ...
                    costLedger: "五维算账",
                    routeList: "成就成本账本与冲刺路线",
                    costLedgerDescription: "金钱、时间、运气、难度和性价比仅在接口提供真实值时显示并参与排序。",
                    ...
                    difficultyAscending: "难度从低到高",
                    timeAscendingPending: "耗时从低到高（需数据）",
                    costAscendingPending: "成本从低到高（需数据）",
                    noRouteResults: "调整关键词或筛选条件后再试。",
                    costFormulaHint: "综合成本需要金钱、时间、运气和难度四项都有值；任一字段缺失时显示“—”，不会生成虚构评分。",
                    costLevels: {
                        money: { 1: "免费", 2: "少量", 3: "中等", 4: "很贵", 5: "天价" },
                        time: { 1: "几分钟", 2: "几小时", 3: "数天", 4: "数周", 5: "数月" },
                        luck: { 1: "必出", 2: "高概率", 3: "看情况", 4: "低概率", 5: "纯看脸" },
                    },
                    costTiers: { free: "白给", good: "划算", grind: "硬肝", trap: "深坑" },

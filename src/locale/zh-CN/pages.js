export default {
    index: {
        title: "休闲栏目",
        keywords:
            "剑网3休闲栏目,JX3BOX休闲栏目,剑三休闲栏目,奇遇大全,商贾奇才,声望大全,书籍大全,剑三考试,捏脸数据,体型数据,宠物大全,家具大全,坐骑大全,家园蓝图",
        description:
            "剑网3魔盒（JX3BOX）休闲栏目，围绕剑网3玩家日常休闲玩法与资料查询需求，提供奇遇大全、商贾奇才、声望大全、书籍大全、剑三考试、捏脸数据、体型数据、宠物大全、家具大全、坐骑大全、家园蓝图等丰富内容。",
    },

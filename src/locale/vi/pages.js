export default {
    ...
    book: {
        ...
        ui: {
            navigation: "Danh mục sách",
            searchPlaceholder: "Tìm theo tên sách",
            types: { all: "Tất cả", misc: "Tạp tập", taoism: "Đạo học", buddhism: "Phật học" },
            sections: { recent: "Đã đọc gần đây", misc: "Tạp tập", taoism: "Đạo học", buddhism: "Phật học" },
            actions: { viewAll: "Xem tất cả", clearHistory: "Xóa lịch sử", loadMore: "Tải thêm" },
            resultCount: "{count} cuốn sách",
            viewMode: "Kiểu hiển thị",
            viewTypes: { card: "Thẻ", list: "Danh sách" },
            columns: { name: "Tên", type: "Loại", collection: "Bộ sách", description: "Mô tả", origin: "Nguồn" },
            empty: { title: "Không tìm thấy sách phù hợp", description: "Hãy thử từ khóa hoặc danh mục khác" },
        },
        single: {
            title: "Chi tiết sách",
            ...
            ui: {
                ...
                label: "Bộ sưu tập sách",
                achievement: "Thành tựu bộ sách",
                information: "Thông tin sách",
                copyRequirements: "Yêu cầu sao chép",
                content: "Nội dung sách",
                collectionTitle: "Sách cùng bộ · {name}",
                typeName: "Sách",
                current: "Hiện tại",
                locationTitle: "Vị trí bia khắc",
                coordinate: "Tọa độ",
                sourceTypes: { dungeon: "Phó bản", shop: "Cửa hàng", quest: "Nhiệm vụ" },
                robot: {
                    quickGuide: "Thêm bot QQ để nhận hướng dẫn nhanh",
                    copySuccess: "Đã sao chép",
                    replyPrefix: "Gửi",
                ...
                wiki: {
                    ...
                    compatibleLead: "Chưa có hướng dẫn cho phiên bản hiện tại. Nội dung cũ bên dưới chỉ để tham khảo. ",
                    contributeRevision: "Đóng góp chỉnh sửa",
                    compatibleTail: "",
                    revisionLead: "Bản chỉnh sửa này do ",
                    submittedAt: " gửi lúc ",
                    emptyLead: "Chưa có hướng dẫn. ",
                    completeGuide: "Thêm hướng dẫn",
                },
                fields: {
                    origin: "Nguồn",
                    collection: "Bộ sách",
                    readingLevel: "Cấp đọc",
                    playerLevel: "Cấp nhân vật",
                    professionLevel: "Cấp {profession}",
                    vigorCost: "Tiêu hao thể lực",
                    materials: "Nguyên liệu",
                },
                actions: {
                    viewLocation: "Xem vị trí",
                    modernMode: "Đọc hiện đại",
                    classicMode: "Đọc cổ điển",
                },
            },
        },
    },
    ...
    wiki: {
        ...
        difficultyDimensions: {
            money: "Tiền bạc",
            time: "Chi phí thời gian",
            luck: "May mắn",
            costEffectiveness: "Hiệu quả chi phí",
            overall: "Độ khó tổng thể",
            sortAscending: "{label}: từ thấp đến cao",
            sortDescending: "{label}: từ cao đến thấp",
            loadFailed: "Không thể tải các chiều độ khó. Đang sử dụng cấu hình mặc định.",
            sortLoadFailed: "Không thể tải dữ liệu sắp xếp độ khó. Thứ tự hiện tại được giữ nguyên.",
        },
        overview: {
            ...
            ui: {
                ...
                completion: "Tiến độ",
                statistics: {
                    regular: "Thành tựu thường",
                    regularHidden: "Thành tựu thường (ẩn)",
                    wujia: "Thành tựu Ngũ Giáp",
                    wujiaHidden: "Thành tựu Ngũ Giáp (ẩn)",
                    fireworks: "Thành tựu Pháo hoa 99",
                    retired: "Thành tựu tuyệt bản",
                    seniorityUnit: "điểm thâm niên",
                    achievementUnit: "thành tựu",
                    collectedAchievements: "Thành tựu đã ghi nhận",
                    collectedSeniority: "Tổng điểm đã ghi nhận",
                    statisticsScope: "Phạm vi thống kê",
                    includesHidden: "Gồm thành tựu ẩn",
                    visibleOnly: "Chỉ hiển thị",
                    remainingSeniority: "Còn có thể nhận",
                    completedResultCount: "Đã hoàn thành {count}",
                ...
                workbench: {
                    ...
                    role: "Nhân vật",
                    server: "Máy chủ",
                    completedAchievements: "Thành tựu đã hoàn thành",
                    tierTitle: "Tổng quan phân loại",
                    filterNormalAchievements: "Lọc thành tựu thường",
                    filterWujiaAchievements: "Lọc thành tựu Ngũ Giáp",
                    viewHiddenAchievements: "Xem thành tựu ẩn",
                    hiddenTier: "Thành tựu ẩn",
                    categoryProgressHint: "Danh mục chính điều chỉnh theo môn phái; danh mục phụ hiển thị hoàn thành thực tế",
                    secondaryCategories: "{count} danh mục phụ",
                    categorySort: "Sắp xếp danh mục",
                    sortProgressAsc: "Tiến độ thấp đến cao (ưu tiên thiếu hụt)",
                    sortProgressDesc: "Tiến độ cao đến thấp",
                    sortRemainingDesc: "Thâm niên có thể nhận từ cao đến thấp",
                    filters: "Bộ lọc thành tựu",
                    category: "Danh mục",
                    tier: "Bậc thành tựu",
                    ...
                    sortPriority: "Chưa hoàn thành trước",
                    sortPointsDesc: "Điểm cao đến thấp",
                    sortPointsAsc: "Điểm thấp đến cao",
                    sortDifficultyAsc: "Độ khó thấp đến cao",
                    sortTimeAsc: "Chi phí thời gian thấp đến cao",
                    searchPlaceholder: "Tìm tên / mô tả thành tựu",
                    search: "Tìm kiếm",
                    reset: "Đặt lại",
                    categoryPath: "{primary} / {secondary}",
                    resultSummary: "{count} kết quả",
                    minutes: "{count} phút",
                    difficulty: "Độ khó",
                    moneyCost: "Tiền",
                    ...
                    luckCost: "May mắn",
                    costEffectiveness: "Hiệu quả chi phí",
                    overallDifficulty: "Độ khó tổng hợp",
                    completionRate: "Tỷ lệ hoàn thành đã đồng bộ",
                    levelValue: "{value}/5",
                    emptyTitle: "Không có thành tựu phù hợp",
                    emptyDescription: "Hãy thử thay đổi danh mục, trạng thái hoặc điều kiện tìm kiếm.",
                    allCategories: "Tất cả",
                    loadingTitle: "Đang tạo cẩm nang thâm niên",
                    loadingDescription: "Đang tải tiến độ nhân vật và thành tựu.",
                },
            },
        },
        compare: {
            ...
            ui: {
                ...
                export: {
                    ...
                    headers: {
                        ...
                        points: "Điểm thâm niên",
                        difficulty: "Độ khó",
                        moneyCost: "Chi phí tiền",
                        timeCost: "Chi phí thời gian",
                        luckCost: "Chi phí may mắn",
                        costEffectiveness: "Hiệu quả chi phí",
                        completionRate: "Tỷ lệ hoàn thành đã đồng bộ",
                        tags: "Thẻ",
                ...
                workbench: {
                    comparisonRoles: "Nhân vật so sánh",
                    selfBadge: "Tôi",
                    roleLimit: "Tối đa {count} nhân vật",
                    remainingRoleSlots: "Có thể thêm {count} nhân vật",
                    summaryExpand: "Mở tổng quan nhân vật",
                    summaryCollapse: "Thu gọn tổng quan nhân vật",
                    currentScope: "Phạm vi hiện tại",
                    availablePoints: "Có thể cùng làm {points} điểm thâm niên",
                    difficulty: "Độ khó",
                    estimatedTime: "Thời gian dự kiến",
                    minutes: "{count} phút",
                    timeCost: "Chi phí thời gian",
                    levelValue: "{value}/5",
                    analysisSeal: "PT",
                    analysisTitle: "Mở phân tích chi tiết",
                    analysisHint: "Thống kê chéo · Cấu trúc · Danh mục yếu",
                    totalComparison: "So sánh tổng thâm niên",
                    totalComparisonHint: "Đã nhận / tổng thâm niên ghi nhận",
                    crossTitle: "Phân tích chéo",
                    crossHint: "Dùng hai nhân vật đầu tiên",
                    commonCompleted: "Cả hai đã hoàn thành",
                    crossPrimaryOnly: "Chỉ {role} hoàn thành",
                    crossSecondaryOnly: "Chỉ {role} hoàn thành",
                    commonIncomplete: "Cả hai chưa hoàn thành",
                    structureTitle: "Đối chiếu cấu trúc thâm niên",
                    weakTitle: "Danh mục cùng yếu",
                    weakHint: "Phù hợp để tổ đội",
                    needTwoRoles: "Thêm ít nhất hai nhân vật để tạo phân tích chéo và danh mục cùng yếu.",
                },
            },
        },
        leap: {
            ...
            ui: {
                ...
                workbench: {
                    ...
                    futureDataNote: "Số phút ước tính và mức chi phí đề xuất vẫn chờ dữ liệu hoặc quy tắc sau; giá trị thiếu không tham gia ước tính.",
                    systemRecommendation: "ĐỀ XUẤT HỆ THỐNG",
                    recommendationTitle: "Chiến lược {stage}",
                    refreshRecommendation: "Phân tích lại",
                    recommendedCategories: "Phân loại",
                    recommendationCandidateCount: "Ứng viên",
                    recommendationAvailablePoints: "Điểm có thể nhận",
                    recommendedCategoryHeading: "Phân loại ưu tiên ở giai đoạn này",
                    recommendedCategoryMeta: "{count} chưa hoàn thành · {points} điểm",
                    recommendationScore: "Điểm {score}",
                    recommendationCoverage: "Đang dùng {available}/{total} chiều đề xuất",
                    viewRecommendationWeights: "Xem trọng số và độ phủ dữ liệu",
                    categoryWeightNote: "Xếp hạng: chất lượng {quality}% · số mục chưa xong {count}% · tổng điểm {points}%",
                    dimensionCoverage: "Phủ {value}",
                    dimensionPending: "Chờ dữ liệu",
                    recommendationEditableNote: "Bạn vẫn có thể đổi phân loại, thêm hoặc xóa thành tựu trước khi lưu.",
                    generateFromRecommendation: "Tạo theo đề xuất",
                    noRecommendation: "Hiện không có thành tựu thường chưa hoàn thành để đề xuất.",
                    recommendationDimensions: {
                        points: "Điểm nhận được",
                        efficiency: "Hiệu suất thời gian",
                        difficulty: "Độ khó thấp",
                        money: "Ít tốn tiền",
                        time: "Ít tốn thời gian",
                        luck: "Ít ngẫu nhiên",
                    },
                    recommendationStages: {
                        newbie: { label: "Khởi đầu · dưới 30k", description: "Ưu tiên thành tựu dễ, nhanh và ít tốn kém để xây nền điểm ban đầu." },
                        growth: { label: "Phát triển · 30k–75k", description: "Ưu tiên phân loại cân bằng giữa điểm nhận được và công sức bỏ ra." },
                        sprint: { label: "Bứt phá · 75k–100k", description: "Tăng trọng số điểm và mật độ lộ trình để hoàn thành các nhóm giá trị cao." },
                        tribulation: { label: "Vượt ải · 100k+", description: "Khi mục còn lại phân tán, ưu tiên tính khả thi, chi phí dài hạn và lợi ích thực tế." },
                    },
                    allCategories: "Tất cả phân loại",
                    selectedCategories: "Đã chọn {count} phân loại",
                    planRole: "Nhân vật",
                    clients: { std: "Máy chủ chính", origin: "Máy chủ hoài niệm" },
                    planClientMismatchTitle: "Máy chủ của phương án không khớp",
                    planClientMismatchDescription: "Phương án này thuộc {client}. Hãy chuyển sang máy chủ tương ứng để xem hoặc chỉnh sửa.",
                    planClientMismatchWarning: "Phương án này thuộc {client}. Hãy chuyển máy chủ trước.",
                    difficultyLimit: "Giới hạn độ khó",
                    noLimit: "Không giới hạn",
                    andBelow: "trở xuống",
                    routeStrategy: "Chiến lược lộ trình",
                    strategyEasy: "Dễ trước (khuyên dùng)",
                    strategyPoints: "Điểm cao trước",
                    strategyEfficiencyPending: "Hiệu suất thời gian (chờ dữ liệu)",
                    strategyCostPending: "Chi phí thấp (chờ dữ liệu)",
                    mapScope: "Phạm vi bản đồ",
                    allMaps: "Tất cả bản đồ",
                    categoryScope: "Phân loại tham gia",
                    ...
                    expectedGain: "Điểm dự kiến",
                    routeItems: "Số mục",
                    completionRate: "Hoàn thành",
                    estimatedTime: "Thời gian dự kiến",
                    averageDifficulty: "Độ khó trung bình",
                    projectedSeniority: "Điểm sau hoàn thành",
                    surplusPoints: "Vượt mục tiêu",
                    remainingGap: "Còn thiếu",
                    minuteValue: "{value} phút",
                    hourValue: "{value} giờ",
                    ...
                    timeCost: "Chi phí thời gian",
                    luck: "May mắn",
                    costPerformance: "Hiệu suất",
                    overallDifficulty: "Độ khó tổng hợp",
                    globalCompletionRate: "Tỷ lệ hoàn thành đã đồng bộ",
                    tags: "Thẻ",
                    levelValue: "{value}/5",
                    schoolRestriction: "Môn phái",
                    routeNote: "Ghi chú / lối tắt",
                    action: "Thao tác",
                    removeRouteItem: "Xóa",
                    removeRouteItemLabel: "Xóa {name} khỏi lộ trình",
                    addRouteItems: "Thêm thành tựu",
                    addRouteItemsDescription: "Tìm thành tựu thường chưa hoàn thành của nhân vật. Tổng lộ trình sẽ tự cập nhật sau khi thêm.",
                    searchRouteItemsToAdd: "Tìm tên hoặc mô tả thành tựu",
                    searchRouteItems: "Tìm kiếm",
                    searchingRouteItems: "Đang tìm…",
                    addRouteItem: "Thêm vào lộ trình",
                    routeItemAdded: "Đã thêm",
                    addRouteItemsSearchHint: "Nhập từ khóa để tìm thành tựu có thể thêm.",
                    noRouteItemsToAdd: "Không tìm thấy thành tựu thường chưa hoàn thành phù hợp.",
                    addRouteItemsSearchFailed: "Không thể tìm thành tựu. Vui lòng thử lại.",
                    finishAdding: "Hoàn tất",
                    routeOrder: "Thứ tự lộ trình",
                    pointsDescending: "Điểm từ cao xuống thấp",
                    noRouteResults: "Hãy đổi từ khóa hoặc bộ lọc rồi thử lại.",
                    costFormulaHint: "Các chiều độ khó lấy từ API công khai và dùng thang sao 0–5. Giá trị thiếu hiển thị “—”; thẻ giữ nguyên nhãn quản trị.",
                    costLevels: {
                        money: { 1: "Miễn phí", 2: "Ít", 3: "Trung bình", 4: "Đắt", 5: "Rất đắt" },
                        time: { 1: "Vài phút", 2: "Vài giờ", 3: "Vài ngày", 4: "Vài tuần", 5: "Vài tháng" },
                        luck: { 1: "Chắc chắn", 2: "Xác suất cao", 3: "Tùy tình hình", 4: "Xác suất thấp", 5: "Hoàn toàn may rủi" },
                    },
                    savedPlanCount: "{count} kế hoạch",
                    viewPlan: "Xem",
                    editPlan: "Sửa",
                    copyAsMine: "Sao chép vào kế hoạch của tôi",
                    deletePlanShort: "Xóa",
                    requestGuidance: "Nhờ trưởng nhóm tư vấn",
                    guidanceSubmitting: "Đang gửi…",
                    guidanceSubmitted: "Đã gửi yêu cầu",
                    moreActions: "Thêm",
                    guidanceSimulationTitle: "Gửi yêu cầu tư vấn thành tựu",
                    guidanceSimulationDescription: "Chỉ mô phỏng: gửi kế hoạch “{title}” cho nhân vật {role}. Không có dữ liệu nào được gửi lên máy chủ.",
                    guidanceSimulationConfirm: "Gửi mô phỏng",
                    guidanceSimulationSuccess: "Đã tạo yêu cầu mô phỏng. Yêu cầu sẽ vào quy trình duyệt sau khi kết nối API.",
                    updatePlan: "Cập nhật kế hoạch",
                    savePlan: "Lưu kế hoạch",
                    saveDescription: "Lưu {count} thành tựu, dự kiến nhận {points} điểm tư lịch.",
                    saving: "Đang lưu…",
                    updateSuccess: "Đã cập nhật kế hoạch.",
                    updateFailed: "Không thể cập nhật kế hoạch. Vui lòng thử lại sau.",
                    copyTitle: "{title} · Bản sao",
                    loading: "Đang tải kế hoạch đột phá…",
                    roleLoadFailed: "Không thể tải trạng thái thành tựu của nhân vật.",
                    planListLoadFailed: "Không thể tải danh sách kế hoạch.",
                    targetMustExceedCurrent: "Mục tiêu phải cao hơn điểm tư lịch hiện tại.",
                    noCandidates: "Không có thành tựu chưa hoàn thành phù hợp điều kiện hiện tại.",
                    difficultyFallback: "Không có dữ liệu độ khó nên giới hạn độ khó chưa được áp dụng.",
                    planDetailLoadFailed: "Không thể tải chi tiết kế hoạch",
                    localGenerationNote: "Lộ trình đã được tạo cục bộ. Bạn có thể lưu sau khi xác nhận.",
                    discardRoute: "Bỏ lộ trình",
                },
                emptyValue: "—",
            },
        },

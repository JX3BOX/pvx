<template>
    <CommonNav :force-show="true" />
    <CommonHeader />
    <PvxPageShell class="p-adventure-treasure-portrait p-pvx-treasure" full-height>
...
@import "~@/assets/css/adventure/treasure/mobile/treasure.less";

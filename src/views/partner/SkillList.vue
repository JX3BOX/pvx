    ...
    <div class="m-partner-skills" :class="{ 'is-realm': isRealm }">
        ...
        <div v-if="currentSkill" class="m-partner-skill-detail">
            ...
            <div v-if="currentSkill.id || currentSkill.level" class="m-partner-skill-meta">
                ...
                <span v-if="currentSkill.iconId" class="u-partner-skill-meta-item">iconID: {{ currentSkill.iconId }}</span>
            </div>

            <!-- 境界：底部展示解锁道具 -->
            <div v-if="isRealm && currentSkill.unlockItems && currentSkill.unlockItems.length" class="m-partner-skill-items">
